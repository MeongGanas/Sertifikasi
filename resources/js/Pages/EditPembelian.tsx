...
import { PageProps, Pembelian, Product } from "@/types";
...
export default function AddPembelian({
    ...
    barang,
    pembelian,
}: PageProps<{ barang: Product[]; pembelian: Pembelian }>) {
    const [isSubmitted, setIsSubmitted] = useState(false);

    const form = useForm<PembelianSchema>({
        resolver: zodResolver(pembelianSchema),
        defaultValues: {
            barang_id: pembelian.barang_id.toString(),
            jumlah: pembelian.jumlah.toString(),
        },
    });
    ...
    const submit = handleSubmit((values) => {
        ...
        const promise = axios.post(
            `/dashboard/pembelian/${pembelian.id}`,
            formData
        );
        ...
        <DashboardLayout user={auth.user}>
            ...
            <Card x-chunk="dashboard-06-chunk-0">
                <CardHeader>
                    ...
                    <CardDescription>
                        Ubah data di bawah ini untuk mengedit data pembelian.
                    </CardDescription>
                </CardHeader>
                <Form {...form}>
